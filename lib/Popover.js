...
var Popover = (function (_super) {
    ...
    function Popover(props) {
        ...
        _this.startAnimation = function (show) {
            ...
            setTimeout(function () {
                _this.setState({ showView: { opacity: 1 } });
            }, 10);
            setTimeout(function () {
                doneCallback ? doneCallback() : null;
            }, _this.props.duration ? _this.props.duration - 20 : 300);
        };
        _this.onHidden = function () { return _this.setState({ visible: false, isAwaitingShow: false, showView: { opacity: 0 } }); };
        ...
        _this.state = {
            showView: { opacity: react_native_1.Platform.OS === "ios" ? 1 : 0 },
    ...
    Popover.prototype.render = function () {
        var _a = this.state, origin = _a.origin, visible = _a.visible, showView = _a.showView;
        ...
        <react_native_1.View style={[styles.container, !!contentSizeAvailable && styles.containerVisible]}>
          ...
          <react_native_1.Animated.View style={computedStyles.popover} useNativeDriver={useNativeDriver}>
            <react_native_1.Animated.View onLayout={this.measureContent} style={[computedStyles.content, showView]} useNativeDriver={useNativeDriver}>
              {this.props.children}
            </react_native_1.Animated.View>
            <react_native_1.Animated.View style={[computedStyles.arrow, showView]} useNativeDriver={useNativeDriver}/>
          </react_native_1.Animated.View>
